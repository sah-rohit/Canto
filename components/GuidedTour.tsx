...
const STEPS: TourStep[] = [
  {
    ...
    body: "Canto is the AI Galactica Encyclopedia. Type any topic — a concept, a word, a question — and get a comprehensive, fact-checked article generated in real time.",
