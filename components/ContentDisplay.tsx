...
<body>
  ...
  <div class="footer">Generated by Canto</div>
</body>
</html>`);
  ...
  const getCitation = (): string => {
    ...
    const title = topic || "Article";

    if (citationStyle === 'APA') {
      return `${author}. (${year}). ${title}. Canto Encyclopedia. Retrieved ${dateStr}, from https://github.com/sah-rohit/Canto`;
    }
    if (citationStyle === 'MLA') {
      return `${author}. "${title}." Canto Encyclopedia, ${year}, https://github.com/sah-rohit/Canto. Accessed ${dateStr}.`;
    }
    return `${author}. "${title}." Canto Encyclopedia. Last modified ${year}. Accessed ${dateStr}. https://github.com/sah-rohit/Canto.`;
  };
  ...
  return (
    <div style={{ position: 'relative' }} ref={contentRef}>
      {/* ── Table of Contents ── */}
      {headers.length > 0 && (
        <div style={{ marginBottom: '1.5rem', background: 'var(--input-bg)', border: '1px solid var(--border-color)', padding: '1rem', fontFamily: 'monospace' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <h4 style={{ margin: 0, fontSize: '0.9em', letterSpacing: '0.1em' }}>TABLE OF CONTENTS</h4>
      ...
      {!isStreaming && content.length > 0 && (
        <div style={{ marginTop: '2rem', background: 'var(--input-bg)', border: '1px solid var(--border-color)', padding: '1rem', fontFamily: 'monospace' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.5rem' }}>
            <span style={{ fontSize: '0.85em', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Article Sources Citation</span>
          ...
          <p style={{ margin: '0.5rem 0 0 0', fontSize: '0.85em', color: 'var(--text-color)', wordBreak: 'break-word', lineHeight: '1.5' }}>
            {getCitation()}
          </p>
        </div>
      )}
      ...
      {popupPos && (
        <div style={{
          ...
          {['Simplify', 'Go Deeper', 'Show Sources'].map(action => (
            <button
              key={action}
